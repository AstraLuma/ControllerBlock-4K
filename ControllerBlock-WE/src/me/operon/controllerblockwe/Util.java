...
public class Util
{
	...
	{
		return getBlockAtLocation(l, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0));
	}
	...
	public static Block getBlockAtLocation(Location l, Integer x, Integer y, Integer z) {
		return l.getWorld().getBlockAt(l.getBlockX() + x.intValue(), l.getBlockY() + y.intValue(), l.getBlockZ() + z.intValue());
	}

	public static String formatBlockCount(CBlock c) {
		if (c.getParent().getConfigu().getInt(Config.Option.MaxBlocksPerController).intValue() > 0) {
			return "(" + c.numBlocks() + "/" + c.getParent().getConfigu().getInt(Config.Option.MaxBlocksPerController) + " blocks)";
		}
	...
	{
		if ((t1.equals(Material.DIRT)) || ((t1.equals(Material.GRASS)) &&
				(t2.equals(Material.DIRT))) || (t2.equals(Material.GRASS))) {
			return true;
		}

		if ((t1.equals(Material.REDSTONE_TORCH_ON)) || ((t1.equals(Material.REDSTONE_TORCH_OFF)) &&
